...
function prepare() {
    ...
    v1.x = parseFloat(document.getElementById("v1x").value);
    v2.x = parseFloat(document.getElementById("v2x").value);
    v1.y = parseFloat(document.getElementById("v1y").value);
    v2.y = parseFloat(document.getElementById("v2y").value);
...
function boom() {
    let w1=Math.sqrt(v1.x*v1.x+v1.y*v1.y);
    let w2=Math.sqrt(v2.x*v2.x+v2.y*v2.y);
    let a1, a2;
    if(w1!=0) a1=Math.atan2(v1.y,v1.x);
    else a1=0;
    if(w2!=0) a2=Math.atan2(v2.y,v2.x);
    else a2=0;
    let a3=Math.atan2((p2.y-p1.y),(p2.x-p1.x));
    let tmpv1 = (w1*Math.cos(a1-a3)*(m1-m2)+2*m2*w2*Math.cos(a2-a3))/(m1+m2)*Math.cos(a3)+w1*Math.sin(a1-a3)*Math.cos(a3+Math.PI/2);
    let tmpv2 = (w1*Math.cos(a1-a3)*(m1-m2)+2*m2*w2*Math.cos(a2-a3))/(m1+m2)*Math.sin(a3)+w1*Math.sin(a1-a3)*Math.sin(a3+Math.PI/2);
    v1.x=tmpv1;
    v1.y=tmpv2;
    let tmpv3 = (w2*Math.cos(a2-a3)*(m2-m1)+2*m1*w1*Math.cos(a1-a3))/(m2+m1)*Math.cos(a3)+w2*Math.sin(a2-a3)*Math.cos(a3+Math.PI/2);
    let tmpv4 = (w2*Math.cos(a2-a3)*(m2-m1)+2*m1*w1*Math.cos(a1-a3))/(m1+m2)*Math.sin(a3)+w2*Math.sin(a2-a3)*Math.sin(a3+Math.PI/2);
    v2.x=tmpv3;
    v2.y=tmpv4;
    while((p1.x-p2.x)*(p1.x-p2.x)+(p1.y-p2.y)*(p1.y-p2.y)<=1600) {
        p1.x += v1.x;
